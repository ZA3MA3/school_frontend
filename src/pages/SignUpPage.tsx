...
export default function SignUpPage() {
  ...
  const [students, setStudents] = useState<StudentData[]>([{ first_name: '', last_name: '', enrollment_date: '', date_of_birth: '', gender: true }]);
  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    try {
      ...
      window.location.href = '/signup?step=role';
    } catch (err: any) {
  ...
  const handleRoleContinue = () => {
    ...
    if (selectedRoles.includes('teacher') && selectedRoles.includes('parent')) {
      window.location.href = '/signup?step=teacher';
    } else if (selectedRoles.includes('teacher')) {
      window.location.href = '/signup?step=teacher';
    } else if (selectedRoles.includes('parent')) {
      window.location.href = '/signup?step=parent';
    }
  };
  ...
  const handleTeacherSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { otpApi } = await import('@/lib/api');
      await otpApi.createTeacherProfile(hireDate, specialization, className, classDescription);
  ...
  const addStudent = () => {
    setStudents([...students, { first_name: '', last_name: '', enrollment_date: '', date_of_birth: '', gender: true }]);
  };
  ...
  const handleParentSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const validStudents = students.filter(s => s.first_name && s.last_name && s.enrollment_date);
    ...
    switch (step) {
      ...
      case 'role':
        return (
          <Card className="w-full max-w-md dark:bg-zinc-800 relative z-10">
            <CardHeader className="space-y-1">
              <CardTitle className="text-2xl text-center dark:text-white">Select Your Role</CardTitle>
              <CardDescription className="text-center dark:text-gray-400">
            ...
            <CardFooter>
              <Button className="w-full" onClick={handleRoleContinue} disabled={isLoading}>
                Continue
              </Button>
            </CardFooter>
          </Card>
      ...
      case 'teacher':
        return (
          <Card className="w-full max-w-md dark:bg-zinc-800 relative z-10">
            <CardHeader className="space-y-1">
              <CardTitle className="text-2xl text-center dark:text-white">Teacher Information</CardTitle>
              <CardDescription className="text-center dark:text-gray-400">
            ...
            <form onSubmit={handleTeacherSubmit}>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="specialization" className="dark:text-white">Specialization *</Label>
                  <Input
                    id="specialization"
                ...
                <div className="space-y-2">
                  <Label htmlFor="className" className="dark:text-white">Class Name *</Label>
                  <Input
                    id="className"
                ...
                <div className="space-y-2">
                  <Label htmlFor="classDescription" className="dark:text-white">Class Description</Label>
                  <Input
                    id="classDescription"
      ...
      case 'parent':
        return (
          <Card className="w-full max-w-lg dark:bg-zinc-800 relative z-10">
            <CardHeader className="space-y-1">
              <CardTitle className="text-2xl text-center dark:text-white">Parent & Student Information</CardTitle>
              <CardDescription className="text-center dark:text-gray-400">
                Enter your occupation and add students
              </CardDescription>
            </CardHeader>
            ...
            <form onSubmit={handleParentSubmit}>
              <CardContent className="space-y-4 max-h-96 overflow-y-auto">
                ...
                <div className="space-y-2">
                  <Label htmlFor="occupation" className="dark:text-white">Your Occupation *</Label>
                  <Input
                    id="occupation"
                ...
                <div className="border-t pt-4 mt-4">
                  <Label className="dark:text-white text-lg">Students (at least 1) *</Label>
                  
                  {students.map((student, index) => (
                    <div key={index} className="mt-3 p-3 border rounded dark:border-zinc-600">
                      <div className="flex justify-between items-center mb-2">
                        <Label className="dark:text-gray-400">Student {index + 1}</Label>
                        {students.length > 1 && (
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <select
                          ...
                          onChange={(e) => updateStudent(index, 'gender', e.target.value === 'true')}
                        >
                  ...
                  <Button type="button" variant="outline" className="w-full mt-3" onClick={addStudent}>
          ...
          <Card className="w-full max-w-md dark:bg-zinc-800 relative z-10">
            ...
            <form onSubmit={handleTeacherSubmit}>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="classDescription" className="dark:text-white">
                    Class Description
                  </Label>
                  <Input
                    id="classDescription"
